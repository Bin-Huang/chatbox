...
import { Typography, Grid, useTheme, Collapse } from '@mui/material'
            ...
            <Grid container wrap="nowrap" spacing={1.5}>
                ...
                <Grid item xs sm container sx={{ width: '0px', paddingRight: '15px' }}>
                    <Grid item xs>
                        {reasoningContent && (
                            <Box
                                sx={{ marginTop: '0.5rem', fontSize: '0.875rem', color: theme.palette.text.secondary }}
                            >
                                ...
                                <Collapse in={!isReasoningContentCollapsed} timeout="auto" unmountOnExit>
                                    {enableMarkdownRendering ? (
                                        ...
                                        <Typography variant="body2">{reasoningContent}</Typography>
                                    )}
                                </Collapse>
                            </Box>
                        )}
